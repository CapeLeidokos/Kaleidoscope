...
//      in braces. The description can be ommitted.
...
//      individually wrapped in braces. The description can be ommitted.
...
// the recursion. 
// 
// Every invokation of _KRC_EXPORT_FUNCTION or _KRC_EXPORT_VARIABLE defines a 
